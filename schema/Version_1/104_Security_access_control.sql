...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA Audit TO db_admin;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA Audit TO db_admin;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA Audit TO db_admin;
GRANT ALL PRIVILEGES ON SCHEMA Audit TO db_admin;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA Staging TO db_admin;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA Staging TO db_admin;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA Staging TO db_admin;
GRANT ALL PRIVILEGES ON SCHEMA Staging TO db_admin;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA Compliance TO db_admin;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA Compliance TO db_admin;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA Compliance TO db_admin;
GRANT ALL PRIVILEGES ON SCHEMA Compliance TO db_admin;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA Compliance GRANT ALL ON TABLES TO db_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA Compliance GRANT ALL ON SEQUENCES TO db_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA Compliance GRANT ALL ON FUNCTIONS TO db_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA Audit GRANT ALL ON TABLES TO db_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA Audit GRANT ALL ON SEQUENCES TO db_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA Audit GRANT ALL ON FUNCTIONS TO db_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA Staging GRANT ALL ON TABLES TO db_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA Staging GRANT ALL ON SEQUENCES TO db_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA Staging GRANT ALL ON FUNCTIONS TO db_admin;
